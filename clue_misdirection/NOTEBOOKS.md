...
| `08_results_and_evaluation.ipynb` | 9, 10, 11, 12 | ❌ Not yet created | Will load results from NB 06/07, compile summary table (Table 8), feature importance + ablation, sensitivity analysis, failure analysis. |

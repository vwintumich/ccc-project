...
| 08 — Results & Evaluation | [08_results_and_evaluation_2026-03-02.html](https://vwintumich.github.io/ccc-project/clue_misdirection/docs/08_results_and_evaluation_2026-03-02.html) | Table 8, feature importance (Gini, permutation, SHAP), ablation, sensitivity, failure analysis (full-data results) |
| 08 — Results & Evaluation (sample) | [08_results_and_evaluation_sample20K_2026-02-27.html](https://vwintumich.github.io/ccc-project/clue_misdirection/docs/08_results_and_evaluation_sample20K_2026-02-27.html) | Same analyses on 20K sample for development testing (pre-SHAP snapshot) |

#!/bin/bash
# Usage: sbatch scripts/embed_phrases_test.sh
# Make executable first: chmod +x scripts/embed_phrases_test.sh
#SBATCH --job-name=cale_test
...
# --- Run embedding script (sample mode) ---
python scripts/embed_phrases.py --data-dir data/ --batch-size 64 --sample 100
